...
public:	
	...
	//Propriedade visível no editor que vai permitir indicar qual a classe
	//que o objeto pertence
	//Contudo a escolha desta classe será limitada por TSubclassof (Subclasse de)
	//Ou seja neste caso estamos indicando que só será permitido escolher no editor
